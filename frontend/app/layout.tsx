                ...
                <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
                  ...
                  <div className="flex flex-col gap-3 sm:items-end">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="flex h-14 shrink-0 items-center rounded-xl border border-line bg-subtle px-3">
                        <img src="/botchain.svg" alt="BOT Chain" className="botchain-logo h-10 w-auto" />
                      </span>
